        ...
        <main className="flex flex-col items-center mt-8 md:mt-16 px-4 md:px-8 pt-8 md:pt-16 text-center">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4">
                <span className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    <img src={person} alt="Logo" className="h-12 sm:h-16 md:h-20 mx-2" />
                    <span className="block md:inline">has</span>
                </span>
                <span className="block">
                    never been easier.
                </span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl mb-4 md:mb-8 px-2">
            ...
            <div className="flex items-center mb-4 md:mb-8 relative w-full max-w-md">
                <input
                    type="text"
                    value={inputValue}
            ...
            <div className="bg-white p-4 md:p-8 rounded-md w-full max-w-4xl shadow-md">
